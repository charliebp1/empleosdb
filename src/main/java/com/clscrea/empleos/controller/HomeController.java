...
import com.clscrea.empleos.model.Perfil;
...
public class HomeController {
	...
	public String guardarRegistro(Usuario usuario, RedirectAttributes attributes) {
		...
		// Fecha de Registro, la actual del servidor
	...
	/*
	 * InitBinder para Strings si los detecta vacios en el Data Binding los setea a NULL
	 * @param binder
	 */
