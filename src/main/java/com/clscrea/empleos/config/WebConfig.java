package com.clscrea.empleos.config;
...
public class WebConfig implements WebMvcConfigurer{
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		registry.addResourceHandler("/cv/**").addResourceLocations("file:c:/empleos/cv-solicitudes/"); // Windows
		//registry.addResourceHandler("/cv/**").addResourceLocations("file:/empleos/cv-solicitudes/"); // Linux
